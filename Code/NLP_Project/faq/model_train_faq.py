...
train_dataset = CustomTextDataset(tokenizer, "path/to/save/train_faq.csv", "summarized_text", "FAQ")
val_dataset = CustomTextDataset(tokenizer, "path/to/save/val_faq.csv", "summarized_text", "FAQ")
test_dataset = CustomTextDataset(tokenizer, "path/to/save/test_faq.csv", "summarized_text", "FAQ")
